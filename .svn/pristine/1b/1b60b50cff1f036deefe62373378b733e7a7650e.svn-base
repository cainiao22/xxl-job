         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4"><input type="text" class="form-control" name="executorParam" placeholder="请输入“执行参数”" maxlength="500" ></div>
                        <label for="lastname" class="col-sm-2 control-label">父任务Key<font color="black">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="parentJobKey" placeholder="请输入父任务的任务Key,如存在多个逗号分隔" maxlength="100" ></div>
                    </div>
                    <div class="form-group">
...
public class DemoGlueJobHandler extends IJobHandler {
	...
	public ReturnT<String> execute(JobInfoParam jobInfoParam,String... params) throws Exception {
		XxlJobLogger.log("XXL-JOB, Hello World. aaaaa");
...
<div class="modal fade" id="executeModal" tabindex="-1" role="dialog"  aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">基准时间<font color="red">*</font></label>
                        <div class="col-sm-4"><input type="text" class="form-control" name="scheduleTime" placeholder="请输入基准时间" maxlength="50" ></div>
                    </div>
                    <hr>
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-6">
