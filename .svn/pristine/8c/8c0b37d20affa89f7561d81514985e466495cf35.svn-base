...
public final class XxlJobDynamicScheduler implements ApplicationContextAware {
    ...
    public static XxlJobTriggerDependencyDao xxlJobTriggerDependencyDao;
    public static XxlJobTriggerHistoryDao xxlJobTriggerHistoryDao;

    public static XxlJobLogDepService xxlJobLogDepService;
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        XxlJobDynamicScheduler.xxlJobTriggerDependencyDao = applicationContext.getBean(XxlJobTriggerDependencyDao.class);
        XxlJobDynamicScheduler.xxlJobTriggerHistoryDao = applicationContext.getBean(XxlJobTriggerHistoryDao.class);

        XxlJobDynamicScheduler.xxlJobLogDepService = applicationContext.getBean(XxlJobLogDepService.class);
